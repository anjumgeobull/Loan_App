...
class RcBookImagelScreen extends StatefulWidget {
  final GetEnquiryData data;
  RcBookImagelScreen({Key? key,required this.data}) : super(key: key);

  @override
  State<RcBookImagelScreen> createState() => _RcBookImagelScreenState();
}

class _RcBookImagelScreenState extends State<RcBookImagelScreen> {
