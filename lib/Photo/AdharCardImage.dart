...
class AdharCardImagelScreen extends StatefulWidget {
  final GetEnquiryData data;
  AdharCardImagelScreen({Key? key,required this.data}) : super(key: key);

  @override
  State<AdharCardImagelScreen> createState() => _AdharCardImagelScreenState();
}

class _AdharCardImagelScreenState extends State<AdharCardImagelScreen> {
  ...
  void initState() {
    super.initState();
    adhra_pic=widget.data.aadharOrVotingcard;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: textToTrans(
                  input:
            "Adhar Card or Voting Card Image",
            style: TextStyle(
              color: Colors.white,
            ),
          ),
        ...
        Padding(
          ...
          child: ClipRRect(
            ...
            CachedNetworkImage(
              ...
              imageUrl:IMAGE_BASE_URL+adhra_pic,
